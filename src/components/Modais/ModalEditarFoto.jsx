...
export default function ModalEditarFoto({ onClose, idFoto }) {

    async function editarFoto(e) {
        e.preventDefault();
        ...
        await api.put(`/fotos/${idFoto}`, formJson, {
            headers: {
    ...
    return(
        <div class="div br-modal medium" aria-modal="true" role="dialog" aria-labelledby="modalalerttitle">
            <div class="br-modal-header">
                <div class="modal-title" id="modalalerttitle">Editar foto</div>
            ...
            <form method="post" onSubmit={editarFoto}>
