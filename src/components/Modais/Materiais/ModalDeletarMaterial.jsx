...
export default function ModalDeletarMaterial({ onClose, idMaterial }) {

    async function deletarMaterial(idMaterial) {
    ...
    return(
        <div>
            ...
            <div class="br-modal-header">
                <div class="modal-title" id="modalalerttitle">Deletar material didático</div>
            ...
            <div class="br-modal-body">
                <p>Você tem certeza que deseja deletar esse material didático?</p>
            </div>
            <div class="br-modal-footer justify-content-end">
                <button class="br-button secondary" type="button" onClick={onClose}>Cancelar
                </button>
                <button class="br-button primary ml-2" type="button" onClick={() => {deletarMaterial(idMaterial)}}>Deletar
                </button>
            </div>
            </div>
        </div>
