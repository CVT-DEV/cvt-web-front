...
export default function ModalEditarMaterial({ onClose, idMaterial }) {
    ...
    async function editarMaterial(e) {
        ...
        await api.put(`/materiais/${idMaterial}`, formJson, {
            headers: {
    ...
    return(
        <div class="div br-modal medium" aria-modal="true" role="dialog" aria-labelledby="modalalerttitle">
            <div class="br-modal-header">
                <div class="modal-title" id="modalalerttitle">Editar material didático</div>
            ...
            <form onSubmit={editarMaterial}>
                <div class="br-modal-body" style={styles.modalBody}>
                    ...
                    <Input name="file" titulo="Arquivo" placeholder="Faça o upload do arquivo aqui" file={true} required/>
