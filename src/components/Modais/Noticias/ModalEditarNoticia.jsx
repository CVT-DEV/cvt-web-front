...
export default function ModalEditarNoticia({ onClose, idNoticia }) {

    async function editarNoticia(e) {
        e.preventDefault();
        ...
        await api.put(`/noticias/${idNoticia}`, formJson, {
            headers: {
    ...
    return(
        <div class="div br-modal medium" aria-modal="true" role="dialog" aria-labelledby="modalalerttitle">
            <div class="br-modal-header">
                <div class="modal-title" id="modalalerttitle">Editar Notícia</div>
            ...
            <form method="post" onSubmit={editarNoticia}>
